...
| Annotated organelle genome map | `ANNOTATE` | Inline SVG. Features from MITOS2 (animal) or the plant annotator TBD ([§8](07-open-questions.md#8-remaining-open-questions)); tooltip shows name, product, strand, coordinates, source score. |
